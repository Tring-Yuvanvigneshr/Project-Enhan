...
import { GET_BOOKINGS_BY_WORKER, GET_WORKER_DETAILS } from '../../../graphQl/queries/userQueries.js';
import { GET_FILTERED_BOOKINGS_BY_WORKER } from '../../../graphQl/queries/workerQueries.js';
import './workerserviceHistory.css';
import { useSelector } from 'react-redux';
import { FormControl, MenuItem, Select } from '@mui/material';
import { useNavigate } from 'react-router-dom';

const WorkerServiceHistory = () => {
  ...
  const worker = data?.workerForworker
...
export default WorkerServiceHistory;
