...
import { UPDATE_BOOKING_STATUS } from '../../../graphQl/mutation/userMutation'
import {
  Card,
  CardContent,
  Typography,
...
const ServiceHistory = () => {
  ...
  const { data: customerData } = useQuery(GET_CUSTOMER_DETAILS_BY_USERID, {
    variables: { userId: user.id },
    fetchPolicy: "network-only",
  });

  const customer = customerData?.getCustomerDetailsByUserid;
