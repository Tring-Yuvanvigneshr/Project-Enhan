...
const ProfileInfo = () => {
  ...
  const customerDetails = data?.getCustomerDetailsByUserid
  ...
  useEffect(() => {
    if (customerDetails) {
      ...
      setOriginalMobile(customerDetails.phone);
    }
  }, [customerDetails]);
  ...
  const validateForm = async () => {
    ...
    if (formData.mobile !== originalMobile && !otpSend) {
      toast.error("Please send OTP first!");
      return;
    }

    const isOtpValid = formData.mobile !== originalMobile && await verifyOtp(`+91${formData.mobile}`, formData.otp);

    if (formData.mobile !== originalMobile && !isOtpValid) {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="phone-container">
            ...
            <input
              ...
              required
            />
            {formData.mobile !== originalMobile && (
          ...
          <button type="button" className="get-location-btn" onClick={handleGetLocation}>
